...
def detect(cfg,opt):
    ...
    for i, (path, img, img_det, vid_cap,shapes) in tqdm(enumerate(dataset),total = len(dataset)):
        ...
        if dataset.mode == 'images':
            ...
            img_det = show_seg_result_xy(img_det, (da_seg_mask, ll_seg_mask), _, _, is_demo=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='./weights/epoch-195.pth', help='model.pth path(s)')
    ...
    parser.add_argument('--show-img', default= None, help='update all models')
